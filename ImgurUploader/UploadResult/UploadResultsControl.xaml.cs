    ...
    public sealed partial class UploadResultsControl : UserControl
    {
        ...
        public FinishedUploadResult Result
        {
            ...
            set
            {
                ...
                CopyableLinksStackPanel.Children.Clear();
                if (_result != null)
                {
                    ...
                    {
                        //Assume album upload
                        CopyableLinksStackPanel.Children.Add(new CopyableLinkControl("Link to Album (email & IM)", String.Format("http://imgur.com/a/{0}", _result.AlbumCreateResults.Data.ID), true));
                    }
                }
            }
        }

        public UploadResultsControl()
        {
